...
public class DruidFilterConfiguration {
	...
	private static final String FILTER_PREFIX = DataSourceConstants.PROPERTY_PREFIX_DRUID + ".filter";

	private static final String FILTER_STAT_PREFIX = FILTER_PREFIX + ".stat";

	private static final String FILTER_CONFIG_PREFIX = FILTER_PREFIX + ".config";

	private static final String FILTER_ENCODING_PREFIX = FILTER_PREFIX + ".encoding";

	private static final String FILTER_SLF4J_PREFIX = FILTER_PREFIX + ".slf4j";

	private static final String FILTER_LOG4J_PREFIX = FILTER_PREFIX + ".log4j";

	private static final String FILTER_LOG4J2_PREFIX = FILTER_PREFIX + ".log4j2";

	private static final String FILTER_COMMONS_LOG_PREFIX = FILTER_PREFIX + ".commons-log";

	private static final String FILTER_WALL_PREFIX = FILTER_PREFIX + ".wall";
