...
public class SslUtils {
	...
	public static SSLContext createSSLContext(KeyStore keyStore, String keystorePassword, String keyPassword, KeyStore trustStore)
		...
		try {
			...
			if (keyStore != null) {
				...
				keymanagers = createKeyManagers(keyStore, StringUtils.isNotBlank(keyPassword) ? keyPassword : keystorePassword);
			}
			if (trustStore != null) {
				if (logger.isDebugEnabled()) {
